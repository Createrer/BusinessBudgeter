...
public interface SettingService {
	...
	/*
	 * List<RosterEvent> getSettingEventList(Date transactionDate);
	 * 
	 * boolean addNewEventList(int eventid, String eventname);
	 */
	...
	RosterEvent getRosterEventDetail(int roster_eventid);
	...
	boolean updateWeekDayBudget(List<BudgetSetting> budgetSettings);
