...
public interface RosterService {
	...
	List<Roster> getShiftDetails(Integer incomeCenterId, Date tosterDate);
	...
	List<StaffRosters> getStaffRosters(Date transactionRosterDate, Integer incomeCenterId, User userDetails, String workofhouse);

	List<StaffRostersServices> getStaffRostersServices(Date transactionRosterDate, Integer incomeCenterId, User userDetails);

	List<StaffRostersEvents> getStaffRostersEvents(Date transactionRosterDate, Integer incomeCenterId, User userDetails);

	void updateStaffRosters(Integer indexOneStaffId, String startTime, String finishTime, String totalHours);
	...
	void updateShiftRoster(int parseInt, String startTime, String finishTime, String totalHours,User userDetails);
