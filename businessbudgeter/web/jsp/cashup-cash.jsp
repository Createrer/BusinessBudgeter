	...
	$(document).ready(function(){
		var index;	 		
 		for(index = 0; index < noOfTill; index++){
 			console.log("before  .floatAmt noOfTill = "+noOfTill);
	        $(".floatAmt"+index).each(function() {
	        	console.log("before inside .floatAmt ");
...
<BODY onload="noBack();"
	...
	<div class="mainwrapper">
		...
		<div class="main-title">
				...
				<div class="row">
				<div class="panel panel-default" style="margin:0 20px 0 5px">
				<div class="panel-body">
				<div class="col-md-12" style="text-align:center; margin-bottom:20px; font-weight:bold; color:#4a5e0b;">
					...
					<div class="col-md-4">
						...
						<a href="javascript:void(0)"><input type="text" size="10" style="font-size:14px !important" class="myDate" name= serviceDate id="serviceDate" value = ${ transactionDate }></a> <a href="javascript:void(0)"><img width="17" height="18" src="images/next.png" class="nextDate" id="nextDate"></a> 
						</span>
					</div><!-- col-md-4 -->
					...
					<div class="col-md-4">
					<span class="day" STYLE="font-size: 10pt;font-weight: bold; margin:10px 5px 0 0;">Income Centers: </span>
		      ...
		      <!-- <option value=" ">Select Income Center</option> -->
					...
					<span><select style="width: 159px;" class="input-serch" name="serviceId" id="serviceId" onchange="handleChangeInputs()" onload="selectIncomeCenter(this.value)">
		      <!-- <option value=" ">Select Income Center</option> -->
		   ...
		   <div class="cs_slider">
				<c:forEach items="${tillDetailsList}" var="tillDetails" varStatus="loop">
					<c:if test="${loop.index % 2 == 0}">
						...
						<table width="95%" cellspacing="0" cellpadding="5" border="0" style="margin: 0px 30px;" align="left">
					  	 	<tr>
					    		<td><h3>${tillDetails.tillName}(${loop.index+1} / ${tillDetailsListCount})</h3></td>
					     	</tr>
					  	 	<tr>
						    <td align="left" valign="top">
							    <table width="95%" border="0" cellspacing="0" cellpadding="0" bgcolor="#c0e057" class="table table-bordered ServiceEevnt">
							      <tr>
		        				...
		        				<!-- <th   class="thclass">Less Float</th> -->
							      ...
							      <c:forEach items="${tillDetails.cashUpCashsList}" var="cashUpCash" varStatus="cashUpCashLoop">
								      <tr>
								        ...
								        <td align="center">
								        <input type="text" cashTypeName="${cashUpCash.cashTypeName}" indexOne="${loop.index}" style="width:80px !important; text-align:right!important" id="floatAmount${loop.index}${cashUpCashLoop.index}" name="floatAmount${loop.index}${cashUpCashLoop.index}" 
								        	class="form-control input-drawer floatAmt${loop.index} " value="${cashUpCash.floatAmount}" onkeypress="javascript:return isNumber(event)" onkeyup="test(${loop.index},${cashUpCashLoop.index})" onchange="makeDirty(document.cashUpCash.isDirty${loop.index}${cashUpCashLoop.index})" 
								        	onclick=" $(this).select();" tabindex="0" maxlength="9" data-v-max="999999999.99" data-m-dec="2"/></td>
								        <td align="center">
								        	<input type="text" cashTypeName="${cashUpCash.cashTypeName}" indexOne="${loop.index}" 
								        	style="width:80px !important; text-align:right!important" id="drawerAmount${loop.index}${cashUpCashLoop.index}" 
								        	name="drawerAmount${loop.index}${cashUpCashLoop.index}" class="form-control input-drawer drawerAmt${loop.index}" value="${cashUpCash.drawerAmount}" 
								        	onkeyup="test(${loop.index},${cashUpCashLoop.index})" onchange="makeDirty(document.cashUpCash.isDirty${loop.index}${cashUpCashLoop.index})" 
								       ...
								       <%--  <td><input type="text" style="width:80px !important" id="lessfloatAmount${cashUpCashLoop.index}" name="lessfloatAmount${cashUpCashLoop.index}" class="input-drawer lessfloatAmt"  tabindex="-1" readonly="readonly" /></td> --%>
								        <td align="center">
								        	<input type="text" indexOne="${loop.index}" style="width:80px !important; text-align:right!important" id="cashTaking${loop.index}${cashUpCashLoop.index}" 
								        	class="form-control input-drawer cashTakingAmt${loop.index}" value="" tabindex="-1" readonly="readonly"  tabindex="-1"/></td>
								      </tr>
							      </c:forEach>
							      <tr class="total">
        ...
        <table   bgcolor="#c0e057" class="ServiceEevnt table table-bordered">
		  ...
		  <tr style="background:#f8f8f8;" id="RestaurantSalesRow">
		    <td >Restaurant</td>
		    <td align="center">
		    	<input type="hidden" class="input" id="cashSalesId" name="cashSalesId" value="${cashSale.cashSalesId}" onkeypress="javascript:return isNumber (event)">
		    	<input type="text" class="input1 form-control salesCover" id="restaurantCovers" name="restaurantCovers" value="${cashSale.restaurantCovers}" style=" text-align: right: ; " onkeypress="javascript:return isInteger(event)" size="8">
		    </td>
		...
		<div class="accordion-manual-header">
		  <table width="20%" border="0" cellspacing="2" cellpadding="0">
		    ...
		    <tr>
		      ...
		      <span style="float:left;"><img src="images/icon_purchese.png" width="24" height="24" /></span>
		      <span style="float:left; padding-top:5px"> Food Purchases</span>  <span style="float:left; margin-left:10px"><a href="#"  class="btn btn-success" id="addBtn" data-toggle="modal" data-target="#cashup-add-popup" onclick=" addFoodPurchase();"><i class="fa fa-plus" style="padding-right:5px"></i>Add</a></span>
			  </div>
			  </td>
	        </tr>
		      </thead>
		...
		<div class="accordion-manual-header">
		  <table width="20%" border="0" cellspacing="2" cellpadding="0">
		    ...
		    <td>
		      ...
		      <span style="float:left;"><img src="images/icon_purchese.png" width="24" height="24" /></span>
		      <span style="float:left; padding-top:5px">Beverage Purchases</span>
		      <span style="float:left; margin-left:10px"><a href="#"  class="btn btn-success" id="addBtn" onclick="addBeveragePurchase();" data-target="#cashup-add-popup" data-toggle="modal"><i class="fa fa-plus" style="padding-right:5px"></i>Add</a></span>
		      </div>
		     </td>  
	        </tr>
		      </thead>
		...
		<div class="accordion-manual-header">
		  <table width="20%" border="0" cellspacing="2" cellpadding="0">
		    <tr>
		      <td>
		      	<div class="pad-left20">
		      		<span style="float:left;"><img src="images/icon_voids.png" width="24" height="24" /></span>
		      		<span style="float:left; padding-top:5px">Voids</span>  <span style="float:left; margin-left:10px"><a href="#"  class="btn btn-success" id="addBtn" onclick="addNewCashupVoid()" data-target="#cashup-add-popup" data-toggle="modal"><i class="fa fa-plus" style="padding-right:5px"></i>Add</a></span>
		      	</div>
		      </td>
	        </tr>
	  ...
	  <div class="table-responsive">
  	 <table width="100%" border="0" cellspacing="0" cellpadding="5" bgcolor="#c0e057" class="table table-bordered ServiceEevnt">
	     ...
	     <tr style="background: #FFF none repeat scroll 0% 0%;">
	         <td>Total</td>
	         	<td align="center">
	         		<input style="text-align:center;" name="totalCc" id="totalCc" value="0.0" type="text" class="input1 form-control" size="10" readonly="readonly" tabindex="-1" >
	         	</td>
	         	<td align="center">+</td>
	         	<td align="center">
	         	...
	         	<td>-</td>
	         	<td align="center">
	         		<input style="text-align: center;" name="totalZ" id="totalZ" value="0.0" type="text" class="input1 form-control" onkeypress="javascript:return isNumber (event)" data-v-max="999999999.99" data-m-dec="2" maxlength="9">
	         	</td>
	         	<td align="center">=</td>
         		<td align="center">
	     ...
	     <tr style="background: #FFF none repeat scroll 0% 0%;">
	     	...
	     	<td></td>
	     	 <td align="center">
	     	 	...
	     	 	<input style="text-align: center" name="zReadSummary" size="10" id="zReadSummary" type="text" class="input1 form-control" onkeyup="calculateVarienceSummary()" value="${cashUpZRead.zRead}" onkeypress="javascript:return isNumber (event)" data-v-max="999999999.99" data-m-dec="2" maxlength="9"/>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5" bgcolor="#c0e057" class="table table-bordered ServiceEevnt">
	     ...
	     <tr style="background: #FFF none repeat scroll 0% 0%;">
         	...
         	<td align="center">+</td>
         	<td align="center">
         		<input style="text-align: center;" name="cashTips" id="cashTips" value="0.0" type="text" class="input1 form-control" onkeypress="javascript:return isNumber (event)" data-v-max="999999999.99" data-m-dec="2" maxlength="9" >
         	</td>
         	<td align="center">=</td>
         	<td align="center">
	...
	<div class="modal fade" id="cashup-add-popup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"></div>
 </body>
</html>
